        ...
        <div>
            ...
            <div className="hero" style={{ backgroundImage: `url(${banner})` }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="">
                        <h1 className="mb-5 text-5xl font-bold">Welcome to <span className='underline decoration-pink-500'>buy2nd</span></h1>
                        <br />
                        ...
                        <div className='px-5'>
                            ...
                            <p>When it comes to resale/second-hand/refurbished, we are the most reliable eShop in this world.</p>
                        </div>
                        <br />
